...
Target "RunIKVMCompiler" (fun _ ->
    restoreFolderFromUrl 
        @".\temp\stanford-ner-2013-06-20" 
        "http://nlp.stanford.edu/software/stanford-ner-2013-06-20.zip"
    [IKVMcTask(@"temp\stanford-ner-2013-06-20\stanford-ner.jar", Version=version)]
